...
## ⚡ Executive Brief (`cat profile.txt`)

```yaml
Operator     : Sujal Lamichhane
Role         : Security Operations Analyst @ CryptoGen Nepal
Credentials  : Certified Ethical Hacker (CEH) — EC-Council
Education    : B.Sc CS (Network Technology & Cybersecurity) · Forbes College
Core Focus   : Detection Engineering · SIEM Telemetry · SOAR Automation · Threat Hunting
Primary Stack: Python · Go · Bash · PowerShell · TypeScript · SQL
Location     : Chitwan, Nepal
```

<br/>

## 🚀 Featured Engineering & Academic Research
...
> Enterprise-grade open-source SOC architecture integrating **Wazuh SIEM**, **Suricata NIDS**, **Shuffle SOAR Engine**, **TheHive**, and **MISP**. Orchestrates real-time threat detection, event correlation, and automated incident triage.
...
> Multi-tiered defense-in-depth architecture featuring centralized SIEM monitoring, Sysmon host-based process tracing, Snort/Suricata perimeter defense, and threshold alerting pipelines.

```
├── 1. Perimeter Layer   Network Firewall + Snort/Suricata IDS
...
### 🌐 Production Threat Intel Platform
**[threatbase](https://github.com/kalidada18/threatbase)** &nbsp;·&nbsp; `TypeScript · Python · React · Cloudflare`
> High-throughput OSINT aggregation platform consolidating 54 threat feeds into deduplicated blocklists across IP, CIDR, Domain, URL, and SHA-256 IOCs.
...
### 🛡️ ML Network Firewall Platform
...
## 🔬 Additional Security Research Repositories

| Project | Tech Stack | Research Domain |
|:--------|:-----------|:----------------|
| **[honeypot-java](https://github.com/kalidada18/honeypot-java)** | `Java` | Decoy telemetry collector for active attack profiling |
| **[dos-attack](https://github.com/kalidada18/dos-attack)** | `Python` | Volumetric & protocol resilience stress-testing framework |
| **[dns-spoofing-tool](https://github.com/kalidada18/dns-spoofing-tool)** | `Python` | ARP poisoning & rogue DNS resolution simulation |
...
## 🛠️ Security Arsenal & Skill Matrix
